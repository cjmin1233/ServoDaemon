...
constexpr uint16_t IDX_POS_COMMAND_AVG_FILTER = 0x210A; // unsigned 16 bit, 0 to 10'000, default 0, 0.1ms, rw
constexpr uint16_t IDX_POS_LIMIT_FUNCTION     = 0x2400; // unsigned 16 bit, default 0, rw
constexpr uint16_t IDX_ROTATION_DIRECTION     = 0x2004; // unsinged 16 bit, 0 to 1, default 0, rw, effective after reboot
constexpr uint16_t IDX_ACCUMULATED_OVERLOAD   = 0x2603; // signed 16 bit, -32768 to 32767, ro,
